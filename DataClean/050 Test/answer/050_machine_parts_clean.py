...
data_path = base_dir / "data" / "machine_parts_dirty.csv"
...
clean.to_csv(output_dir / "machine_parts_clean.csv", index=False, encoding="utf-8-sig")
pd.DataFrame(bounds_rows).to_csv(output_dir / "machine_parts_iqr_bounds.csv", index=False, encoding="utf-8-sig")
before_summary.to_csv(output_dir / "machine_parts_summary_before.csv", index=False, encoding="utf-8-sig")
after_summary.to_csv(output_dir / "machine_parts_summary_after.csv", index=False, encoding="utf-8-sig")
report.to_csv(output_dir / "machine_parts_cleaning_report.csv", index=False, encoding="utf-8-sig")
