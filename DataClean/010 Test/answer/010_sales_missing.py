...
data_path = base_dir / "data" / "sales_missing.csv"
...
mean_df.to_csv(output_dir / "sales_filled_mean.csv", index=False, encoding="utf-8-sig")
median_df.to_csv(output_dir / "sales_filled_median.csv", index=False, encoding="utf-8-sig")
mixed_df.to_csv(output_dir / "sales_filled_mode_fixed.csv", index=False, encoding="utf-8-sig")
comparison.to_csv(output_dir / "sales_fill_mean_comparison.csv", index=False, encoding="utf-8-sig")
report.to_csv(output_dir / "sales_missing_report.csv", index=False, encoding="utf-8-sig")
