...
data_path = base_dir / "data" / "production_line_sensor.csv"
output_dir = base_dir / "output"
output_dir.mkdir(parents=True, exist_ok=True)

fields = ['temperature', 'pressure', 'vibration', 'current']
...
summary.to_csv(output_dir / "production_line_numeric_summary.csv", index=False, encoding="utf-8-sig")
bounds.to_csv(output_dir / "production_line_iqr_bounds.csv", index=False, encoding="utf-8-sig")
outliers.to_csv(output_dir / "production_line_iqr_outliers.csv", index=False, encoding="utf-8-sig")
report.to_csv(output_dir / "production_line_iqr_report.csv", index=False, encoding="utf-8-sig")
