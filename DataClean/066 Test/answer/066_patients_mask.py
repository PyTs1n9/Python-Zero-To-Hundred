...
data_path = base_dir / "data" / "patients_private.csv"
...
full_df.to_csv(output_dir / "patients_masked_full.csv", index=False, encoding="utf-8-sig")
partial_df.to_csv(output_dir / "patients_masked_partial.csv", index=False, encoding="utf-8-sig")
report.to_csv(output_dir / "patients_mask_validation_report.csv", index=False, encoding="utf-8-sig")
print("全字段掩码前 5 行：\n", full_df.head())
print("部分掩码前 5 行：\n", partial_df.head())
