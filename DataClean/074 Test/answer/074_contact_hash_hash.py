...
data_path = base_dir / "data" / "contact_hash_private.csv"
...
sha_df.to_csv(output_dir / "contact_hash_hash_sha256.csv", index=False, encoding="utf-8-sig")
md5_df.to_csv(output_dir / "contact_hash_hash_md5.csv", index=False, encoding="utf-8-sig")
report.to_csv(output_dir / "contact_hash_hash_consistency_report.csv", index=False, encoding="utf-8-sig")
...
"""
(output_dir / "contact_hash_hash_comparison.txt").write_text(comparison, encoding="utf-8")
