...
data_path = base_dir / "data" / "iot_sensor_data.csv"
...
summary.to_csv(output_dir / "iot_sensor_numeric_summary.csv", index=False, encoding="utf-8-sig")
bounds.to_csv(output_dir / "iot_sensor_iqr_bounds.csv", index=False, encoding="utf-8-sig")
outliers.to_csv(output_dir / "iot_sensor_iqr_outliers.csv", index=False, encoding="utf-8-sig")
report.to_csv(output_dir / "iot_sensor_iqr_report.csv", index=False, encoding="utf-8-sig")
