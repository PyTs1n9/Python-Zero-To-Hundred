...
data_path = base_dir / "data" / "employee_private.csv"
...
save_heatmap(pearson_before, "Pearson Correlation Before Masking", "employee_pearson_before_heatmap.png")
save_heatmap(pearson_after, "Pearson Correlation After Masking", "employee_pearson_after_heatmap.png")
...
masked.to_csv(output_dir / "employee_masked.csv", index=False, encoding="utf-8-sig")
stats.to_csv(output_dir / "employee_stats_comparison.csv", index=False, encoding="utf-8-sig")
pearson_before.to_csv(output_dir / "employee_pearson_before.csv", encoding="utf-8-sig")
pearson_after.to_csv(output_dir / "employee_pearson_after.csv", encoding="utf-8-sig")
pearson_difference.to_csv(output_dir / "employee_pearson_difference.csv", encoding="utf-8-sig")
report.to_csv(output_dir / "employee_usability_report.csv", index=False, encoding="utf-8-sig")
