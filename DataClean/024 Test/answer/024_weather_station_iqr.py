...
data_path = base_dir / "data" / "weather_station.csv"
...
summary.to_csv(output_dir / "weather_station_numeric_summary.csv", index=False, encoding="utf-8-sig")
bounds.to_csv(output_dir / "weather_station_iqr_bounds.csv", index=False, encoding="utf-8-sig")
outliers.to_csv(output_dir / "weather_station_iqr_outliers.csv", index=False, encoding="utf-8-sig")
report.to_csv(output_dir / "weather_station_iqr_report.csv", index=False, encoding="utf-8-sig")
