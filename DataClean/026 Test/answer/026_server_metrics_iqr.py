...
data_path = base_dir / "data" / "server_metrics.csv"
output_dir = base_dir / "output"
output_dir.mkdir(parents=True, exist_ok=True)

fields = ['cpu_usage', 'memory_usage', 'response_ms']
...
summary.to_csv(output_dir / "server_metrics_numeric_summary.csv", index=False, encoding="utf-8-sig")
bounds.to_csv(output_dir / "server_metrics_iqr_bounds.csv", index=False, encoding="utf-8-sig")
outliers.to_csv(output_dir / "server_metrics_iqr_outliers.csv", index=False, encoding="utf-8-sig")
report.to_csv(output_dir / "server_metrics_iqr_report.csv", index=False, encoding="utf-8-sig")
