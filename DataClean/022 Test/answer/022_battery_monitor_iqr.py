...
data_path = base_dir / "data" / "battery_monitor.csv"
...
summary.to_csv(output_dir / "battery_monitor_numeric_summary.csv", index=False, encoding="utf-8-sig")
bounds.to_csv(output_dir / "battery_monitor_iqr_bounds.csv", index=False, encoding="utf-8-sig")
outliers.to_csv(output_dir / "battery_monitor_iqr_outliers.csv", index=False, encoding="utf-8-sig")
report.to_csv(output_dir / "battery_monitor_iqr_report.csv", index=False, encoding="utf-8-sig")
