...
data_path = base_dir / "data" / "engineer_private.csv"
output_dir = base_dir / "output"
output_dir.mkdir(parents=True, exist_ok=True)

numeric_fields = ['age', 'work_years', 'monthly_salary', 'performance_score']
...
save_heatmap(pearson_before, "Pearson Correlation Before Masking", "engineer_pearson_before_heatmap.png")
save_heatmap(pearson_after, "Pearson Correlation After Masking", "engineer_pearson_after_heatmap.png")
...
masked.to_csv(output_dir / "engineer_masked.csv", index=False, encoding="utf-8-sig")
stats.to_csv(output_dir / "engineer_stats_comparison.csv", index=False, encoding="utf-8-sig")
pearson_before.to_csv(output_dir / "engineer_pearson_before.csv", encoding="utf-8-sig")
pearson_after.to_csv(output_dir / "engineer_pearson_after.csv", encoding="utf-8-sig")
pearson_difference.to_csv(output_dir / "engineer_pearson_difference.csv", encoding="utf-8-sig")
report.to_csv(output_dir / "engineer_usability_report.csv", index=False, encoding="utf-8-sig")
