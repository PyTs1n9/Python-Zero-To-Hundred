...
data_path = base_dir / "data" / "network_latency.csv"
output_dir = base_dir / "output"
output_dir.mkdir(parents=True, exist_ok=True)

fields = ['latency_ms', 'packet_loss']
...
summary.to_csv(output_dir / "network_latency_numeric_summary.csv", index=False, encoding="utf-8-sig")
bounds.to_csv(output_dir / "network_latency_iqr_bounds.csv", index=False, encoding="utf-8-sig")
outliers.to_csv(output_dir / "network_latency_iqr_outliers.csv", index=False, encoding="utf-8-sig")
report.to_csv(output_dir / "network_latency_iqr_report.csv", index=False, encoding="utf-8-sig")
