...
data_path = base_dir / "data" / "component_length.csv"
...
pd.DataFrame(comparison_rows).to_csv(output_dir / "component_length_outlier_detection_comparison.csv", index=False, encoding="utf-8-sig")
df.loc[z_any].to_csv(output_dir / "component_length_zscore_outliers.csv", index=False, encoding="utf-8-sig")
clean_delete.to_csv(output_dir / "component_length_clean_delete.csv", index=False, encoding="utf-8-sig")
clean_clip.to_csv(output_dir / "component_length_clean_clip.csv", index=False, encoding="utf-8-sig")
clean_replace.to_csv(output_dir / "component_length_clean_replace.csv", index=False, encoding="utf-8-sig")
treatment.to_csv(output_dir / "component_length_treatment_comparison.csv", index=False, encoding="utf-8-sig")
